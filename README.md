...
```javascript
ternaryLoopOrder = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-binary-loop-interchange-order@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var ternaryLoopOrder = require( 'path/to/vendor/umd/ndarray-base-binary-loop-interchange-order/index.js' )
```
